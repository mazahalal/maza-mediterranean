...
export const menuData: MenuCategory[] = [
  {
    ...
    items: [
      { name: "Beef + Lamb Gyro", price: "$10.91", image: "/images/maza/menu/opt-beef-gyro-vertical.jpg", notes: ["Beef + lamb, same blend as our shish kebab", "Served on pita or as a wrap"] },
