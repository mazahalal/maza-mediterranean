      ...
      <div className="max-w-6xl mx-auto">
        <div className="text-center mb-12">
          ...
          <p className="text-[#B8B8B8] text-lg max-w-2xl mx-auto">
            All plates come with 2 kebabs (unless noted), rice, salad, hummus + tahini. Big portions. Real ingredients.
          </p>
        </div>

        <div className="grid gap-6 md:grid-cols-2 lg:grid-cols-3">
          {plates?.items.map((item, index) => (
        ...
        <RelatedLinks routeKey="menu/plates" heading="Signature plates" />
